...
export default function SharpVision({ highlightedText, heading, subheading }: SharpVisionProps) {
  ...
  <div className="flex flex-col items-center justify-center text-center w-full max-w-xl">
    ...
    {/* Heading */}
    <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-white font-medium whitespace-nowrap leading-tight">
      {heading}
    </h1>

    {/* Description */}
    <div className="max-w-xl text-[#ABABAB] text-sm sm:text-base md:text-md leading-relaxed w-lg px-2 sm:px-0">
      <p>{subheading}</p>
    </div>
  </div>
</section>
