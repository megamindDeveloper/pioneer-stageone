type DynamicContentProps = {  
  ...
  >
    <div className="flex flex-col w-full max-w-xl items-center justify-center text-center gap-4 sm:gap-4 px-4 pb-4 sm:pb-0">
      {/* Subtitle */}
      ...
      {/* Heading */}
      <h1 className="text-[48px] text-white font-medium leading-tight mb-4">
        {heading}
      </h1>
