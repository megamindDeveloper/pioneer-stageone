...
import RightFieldOfVision from "@/components/TextComponents/RightFieldOfVision";
...
export default function Model4TextOverlay() {
 ...
 <div className="w-[300px] md:w-500px">
  ...
  <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-white text-center font-medium">
